...
public class PaginationDemo {
    ...
    public static void main(String[] args) {
        ...
        List<Product> filterPrice400Up = productList.stream()
                .filter(pro -> pro.getPrice() > 400)
                .sorted(Comparator.comparing(Product::getPrice).reversed())
                .toList();

        List<Product> productsFromFebruary = productList.stream()
                .filter(pro -> pro.getCreatedAt().isAfter(LocalDateTime.of(2024, 1, 31, 23, 59)))
